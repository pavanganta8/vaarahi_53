/*
===============================================================================
Stored Procedure: Load Silver Layer (Bronze -> Silver) (Snowflake)
===============================================================================
*/
...
BEGIN
    ...
    SYSTEM$LOG_INFO('================================================');
    SYSTEM$LOG_INFO('Loading Silver Layer');
    SYSTEM$LOG_INFO('================================================');

    SYSTEM$LOG_INFO('------------------------------------------------');
    SYSTEM$LOG_INFO('Loading CRM Tables');
    SYSTEM$LOG_INFO('------------------------------------------------');

    -- Loading silver.crm_cust_info
    start_time := CURRENT_TIMESTAMP();
    SYSTEM$LOG_INFO('>> Inserting Data Into: silver.crm_cust_info');
    ...
    start_time := CURRENT_TIMESTAMP();
    SYSTEM$LOG_INFO('>> Inserting Data Into: silver.crm_prd_info');
    ...
    start_time := CURRENT_TIMESTAMP();
    SYSTEM$LOG_INFO('>> Inserting Data Into: silver.crm_sales_details');
    ...
    start_time := CURRENT_TIMESTAMP();
    SYSTEM$LOG_INFO('>> Inserting Data Into: silver.erp_cust_az12');
    ...
    SYSTEM$LOG_INFO('------------------------------------------------');
    SYSTEM$LOG_INFO('Loading ERP Tables');
    SYSTEM$LOG_INFO('------------------------------------------------');

    -- Loading erp_loc_a101
    start_time := CURRENT_TIMESTAMP();
    SYSTEM$LOG_INFO('>> Inserting Data Into: silver.erp_loc_a101');
    ...
    start_time := CURRENT_TIMESTAMP();
    SYSTEM$LOG_INFO('>> Inserting Data Into: silver.erp_px_cat_g1v2');
    ...
    SYSTEM$LOG_INFO('==========================================');
    SYSTEM$LOG_INFO('Loading Silver Layer is Completed');
    SYSTEM$LOG_INFO('   - Total Load Duration: ' || duration || ' seconds');
    SYSTEM$LOG_INFO('==========================================');

    RETURN 'Silver Layer loaded successfully in ' || duration || ' seconds';

EXCEPTION
    WHEN OTHER THEN
        SYSTEM$LOG_ERROR('==========================================');
        SYSTEM$LOG_ERROR('ERROR OCCURED DURING LOADING SILVER LAYER');
